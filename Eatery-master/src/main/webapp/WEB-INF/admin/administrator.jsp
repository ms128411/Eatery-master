           		...
           		<shiro:hasPermission name="超级管理员">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_table">
                        <thead>
                            ...
                            <th width="70px">状态</th>
                            <c:if test="${role != ''}"><th width="400">操作</th></c:if>
                        </tr>
                        </thead>
                        <tbody>
                            ...
                            <td>
                                <select name="role.roleId" style="width:145px" disabled="disabled" class="${a.userId}">
                                    <c:forEach items="${roleList}" var="r">
                                        <option value="${r.roleName}"<c:if test="${r.roleId==a.role.roleId}">selected="selected"</c:if>>${r.roleName}</option>
                                    </c:forEach>
                                </select>
                            </td>
                            <td class="td-status" >
    ...
    <div id="add_administrator_style" class="add_menber" style="display:none">
        <form action="<%=request.getContextPath()%>/addAdmin" id="form-admin-add">
            <div class="form-group">
                <label class="form-label"><span class="c-red">*</span>登录账户：</label>
            ...
            <div class="form-group">
				...
				<select class="select" name="role.roleName" size="1">
            ...
            <div class="form-group">
				...
				<select class="select" name="userInfo.state" size="1">
...
<script type="text/javascript">
    ...
    function update_Admin(id) {
        ...
        /*$("input[type='text'][class="+id+"][name='userId']").val()*/
