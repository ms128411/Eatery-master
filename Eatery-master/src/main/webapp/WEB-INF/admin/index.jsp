            ...
            <ul class="nav ace-nav">
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                       <span> <small>欢迎光临,</small>${sessionScope.user.username}	</span>
                        <i class="icon-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li> <a id="Exit_system" href="#"><i class="mdi mdi-logout-variant"></i> 退出登录</a> </li>
                    </ul>
                </li>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list" id="nav_list">
                ...
                <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 菜品管理 </span><b class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                        <li class="home"><a  href="javascript:void(0)" name="products"  title="菜谱列表" class="iframeurl"><i class="icon-double-angle-right"></i>商品列表</a></li>
...
<%--                        <li class="home"><a href="javascript:void(0)" name="transaction" title="交易信息"  class="iframeurl"><i class="icon-double-angle-right"></i>交易信息</a></li>--%>
                        <li class="home"><a href="javascript:void(0)" name="orderForm" title="配餐订单管理"  class="iframeurl"><i class="icon-double-angle-right"></i>配餐订单管理</a></li>
                    </ul>
                </li>
<%--                <li>
