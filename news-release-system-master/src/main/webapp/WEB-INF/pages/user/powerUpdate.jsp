...
<div class="layui-form layuimini-form">
    ...
    <input type="hidden" name="oldType"  value="${userType}">
    <div class="layui-form-item">
        <label class="layui-form-label required">用户名</label>
        <div class="layui-input-block">
            <input type="text" name="userName" disabled="disabled" value="${userName}" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label required">用户类型</label>
        <div class="layui-input-block">
            <select class="layui-input" name="newType" id="userType">
...
<script>
    layui.use(['form'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            //向后台发送数据提交添加
            $.ajax({
                url:"/updatePowerSubmit",
                type:"POST",
                data: {//提交数据格式
                    userID:datas.userID,
                    oldType:datas.oldType,
                    newType:datas.newType
                },
