...
<div class="layuimini-container">
    <div class="layui-form layuimini-form">
        <input class="layui-form-item" type="hidden" id="newsID" name="newsID"  value="">
        <input class="layui-form-item" type="hidden" id="content" name="content"  value="">
...
<script type="text/javascript">
    layui.use(['layer','wangEditor','form','upload', 'element'], function () {
        ...
        editor.create();
        editor.txt.html($("#content").attr("value")); //数据回显
        console.log($("#newsID").attr("value"));
    });
</script>
</body>
</html>